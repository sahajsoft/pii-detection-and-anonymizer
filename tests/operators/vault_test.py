...
class TestVaultEncrypt:
    ...
    def test_vault_encrypt_and_result_is_returned(self):
        ...
        with mock.patch.object(hvac, "Client"):
            ...
            anonymized_text = VaultEncrypt().operate(text=expected_text, params={"vault_url": expected_vault_url, "key": expected_vault_key})
    ...
    def test_vault_token_when_supplied_is_used(self):
        ...
        with mock.patch.object(hvac, "Client"):
            ...
            VaultEncrypt().operate(text="", params={"vault_token": expected_vault_token})
...
class TestVaultDecrypt:
    ...
    def test_vault_decrypt_and_result_is_returned(self):
        ...
        with mock.patch.object(hvac, "Client"):
            ...
            deanonymized_text = VaultDecrypt().operate(text="encrypted_text", params={"vault_url": expected_vault_url, "key": expected_vault_key})
    ...
    def test_vault_token_when_supplied_is_used(self):
        ...
        with mock.patch.object(hvac, "Client"):
            ...
            VaultDecrypt().operate(text="encrypted_text", params={"vault_token": expected_vault_token})
